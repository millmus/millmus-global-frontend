...
const SignUp: NextPage = () => {
  ...
  const onValid = async ({
    ...
    // @ts-ignore
    // window.gtag('event', 'conversion', {'send_to': 'AW-10983062731/FzGNCKaMkqsYEMv5kPUo'});
    ...
    const user_obj = {
      ...
      tags: ["가입연동"],
      unsubscribeEmail: !(!!adAgree),
      unsubscribeTexting: !(!!adAgree),
    };
    // @ts-ignore
              ...
              >
                <div className='text-[#cfcfcf]'>
                  <Link href={'/terms-of-service'}>
                    <a target="_blank">
                      <span className='text-[#ff8a00] underline'>서비스이용약관</span>
                    </a>
                  </Link>
                  에 동의합니다. (필수)
                </div>
